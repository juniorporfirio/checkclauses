...
namespace JuniorPorfirio.CheckClauses.Tests
{
    public class StringCheckClausesTest
    {
        ...
        public void Should_return_throw_empty_or_null_string()
        {
            ...
            //Act
            Action clausesEmpty = () => Check.Clauses(inputName, input: empty).IsNullOrEmpty();
            Action clausesNull = () => Check.Clauses(inputName, input: nullable).IsNullOrEmpty();
        ...
        public void Should_return_throw_empty_or_whitespace_string()
        {
            ...
            //Act
            Action clausesEmpty = () => Check.Clauses(inputName, input: whitespace).IsNullOrWhiteSpace();
            Action clausesNull = () => Check.Clauses(inputName, input: nullable).IsNullOrWhiteSpace();
        ...
        public void Should_return_throw_cannot_be_number_string()
        {
            ...
            //Act
            Action clausesNumber = () => Check.Clauses(inputName, input: number).IsNumber();
        ...
        public void Should_return_value_to_number_string()
        {
            ...
            //Act
            var value = Check.Clauses(inputName, input: number).IsNumber();
        ...
        public void Should_return_value_with_length_minor_than_ten()
        {
            ...
            //Act
            var value = Check.Clauses(inputName, input: name).MaxLength(number);
        ...
        public void Should_return_throw_cannot_be_minor_than_ten()
        {
            ...
            //Act
            Action clausesNumber = () => Check.Clauses(inputName, input: name).MaxLength(number);
